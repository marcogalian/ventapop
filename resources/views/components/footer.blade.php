<div class="container-fluid footer-parent">
    <footer class="footer-container pt-4 my-4 border-top row align-items-center">
        ...
        <a class="col-12 col-sm-8 col-md-8 col-lg-8 navbar-brand logo text-light text-center" href="{{ route('home')}}">VentaPop!</a>

        <ul class="nav col-12 col-sm-8 col-md-8 col-lg-8 justify-content-end pe-4 nav-footer">
