<div class="container-fluid footer-parent">
    <footer class="footer-container pt-4 my-4 border-top row align-items-center">
        <p class="col-12 col-lg-4 mb-0 text-muted text-light footer-copyright">© 2023 Ventapop, Marco & Chechu</p>

        <a class="col-12 col-lg-4 navbar-brand logo text-light text-center" href="{{ route('home')}}">VentaPop!</a>
